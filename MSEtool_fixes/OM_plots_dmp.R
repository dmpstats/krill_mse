...
#' =============================================================================
#'
#' Modified date: 09/11/2023 
#' 
#' MSEtool release version: 3.7.0 
#' 
#' Hacker: Bruno Caneco  (BC)
#'
#' Local version of script "OM_plots.r" with functions from {MSEtool} to
#' generate plots for OM Documentation.
#'
#' Changes made to fix a bug in the function `plot.Maturity()`. Bug caused by
#' using a default value for param `nyears = 50` instead of the value specified
#' in OM definitions
#'
